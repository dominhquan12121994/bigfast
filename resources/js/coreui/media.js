    ...
    this.clickFile = function(e){
        axios.get( '/admin/media/file?id=' + e.target.getAttribute("atr") + '&thisFolder=' + document.getElementById('this-folder-id').value )
    ...
    this.folderChangeName = function(e){
        axios.get( '/admin/media/folder?id=' + e.target.getAttribute("atr") )
        .then(function (response) {
