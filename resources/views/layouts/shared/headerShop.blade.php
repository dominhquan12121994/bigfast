...
<div class="c-wrapper">
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <a class="c-header-brand d-sm-none" href="#"><img class="c-header-brand"
                                                          ...
                                                          width="97" height="46" alt="Bigfast Logo"></a>
        ...
        ?>
        @if (isset($currentUser->address))
        @if( !$currentUser->address || !$currentUser->getAddress->first() || ( $currentUser->getAddress->first() && !$currentUser->getAddress->first()->name ) )
            <div class="c-header-nav" style="color:red">Vui lòng cập nhật "<a href="{{ route('shop.profile.edit') }}">Thông tin Shop</a>" để trải nghiệm các dịch vụ của bigfast!</div>
        @endif
        @endif
        ...
        <ul class="c-header-nav ml-auto mr-4">
            <li class="c-header-nav-item dropdown d-md-down-none mx-2" id="notification_item">
                <a class="notification_text" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div id="box" class="dropdown-menu dropdown-menu-right dropdown-menu-lg mt-2 notifications">
                        ...
                        <a class="dropdown-item justify-content-center border-top" href="{{ route('shop.shop-notification.index') }}"><strong>Xem tất cả thông báo</strong></a>
                    </div>
                </a>
            </li>
            ...
            <li class="c-header-nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0">
                    <a class="dropdown-item" href="{{ route('shop.change.password') }}">
    ...
    <script>
        ...
        // console.log('đã load file receive_firebase_message');
        ...
        function readNotification(element) {
            ...
            if ($(element).find('span').hasClass('text-success')) {
                ...
                $.ajax({
                    url: '{{ route("api.update-notification-read") }}',
                    type: 'PUT',
                    data: {
