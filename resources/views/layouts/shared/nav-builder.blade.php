...
?>
      ...
      <div class="c-sidebar-brand">
          <img style="padding: 8px;" class="c-sidebar-brand-full" src="{{ env('APP_URL', '') }}/assets/img/logo_white_new.png" height="103" alt="CoreUI Logo">
          <img class="c-sidebar-brand-minimized" src="{{ env('APP_URL', '') }}/assets/img/favicon_white.png" height="68" alt="CoreUI Logo">
      </div>
