    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <form method="POST" action="{{ route('admin.shop-staff.update', array('shop_staff' => $staff->id)) }}">
                            <div class="card-header justify-content-between d-block d-sm-flex">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.shop-staff.index', array('shop_id' => $staff->shop_id)) }}" class="btn btn-primary return_btn">Trở về</a></div>
                            </div>
                            <div class="card-body">
