                              ...
                              <form class="form-inline" method="GET">
                                  <div class="form-group">
                                      ...
                                      <div class="col-form-label">
                                          <input class="form-control form-control-sm" type="text" placeholder="Nhập mã vận đơn cần tra cứu"
                                                 name="lading_code" id="lading_code" value="{{ $order->lading_code }}" maxlength="12" required autofocus style="width: 220px">
                                      </div>
                                  </div>&nbsp;
                          ...
                          <div class="card-body">
                              <form class="form-horizontal">
                                  ...
                                  <div class="form-group row mb-0">
                                      ...
                                      <div class="col-md-9">
                                          <b>{{ number_format($order->cod + $incurred_total_cod + $transport ) }} đ</b>
                                      </div>
                                  </div>
                                  <div class="form-group row mb-0">
                          ...
                          <div class="card-body">
                              ...
                              <div class="form-group row mb-0">
                                  ...
                                  <div class="form-group row mb-0">
                                      ...
                                      <div class="col-md-9">
                                          <b>{{ number_format($order->total_fee - $order->transport_fee + $incurred_fee_cod ) }} đ</b>
                                      </div>
                                  </div>
                                  <div class="form-group row mb-0">
                          ...
                          <div class="card-body">
                              ...
                              <table class="table table-responsive-sm table-responsive-md table-responsive-lg">
                                  ...
                                  <tr>
                                      ...
                                      <th style="border: none; background: #ebedef; width: 300px">Mô tả</th>
                                      <th style="border: none; background: #ebedef;">Chi tiết</th>
                                      <th style="border: none; background: #ebedef; width: 100px">Thời gian</th>
                                  </tr>
                                  </thead>
                                  <tbody>
                                  @foreach($logsByDate as $log)
                                  <tr>
                                      <td>{{ (isset(\App\Modules\Orders\Constants\OrderConstant::actions[$log->log_type])) ? \App\Modules\Orders\Constants\OrderConstant::actions[$log->log_type] : '' }}</td>
                                      <td>{{ $log->note1 }}</td>
                                      <td>{{ $log->note2 }}</td>
