<div id="modal_aside_left" class="modal fixed-left fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-aside" role="document">
        <div class="modal-content" style="overflow: auto">
            <form action="{{ route('admin.orders.search') }}" method="post" autocomplete="off" id="frmSearch" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('admin.orders.index') . ($shop ? '?shop=' . $shop->id : '') }}"><button type="button" class="btn btn-info">Trở về</button></a>
