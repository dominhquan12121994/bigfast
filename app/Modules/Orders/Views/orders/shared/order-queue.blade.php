    ...
    <div class="col-auto mr-auto">
        <p>
            @if ( $currentUser->can('action_orders_import') )
                Tạo đơn vận chuyển theo <a href="{{ asset('excel/BigFast_MauDanhSachDonHang_2021.xlsx') }}" download>mẫu file excel</a>.<br>
            @endif
            Cập nhật trạng thái đơn vận chuyển sau <span class="badge badge-warning" id="countdown"></span> giây
        </p>
    </div>
