                                    ...
                                    <div class="card-body pt-0 pb-0">
                                        <div class="row">
                                            <div class="col p-0">
                                                ...
                                                <a href="{{ route('admin.orders.drafts', array('shop_id' => $shop->id)) . '?rm=' . $key }}"
                                        ...
                                        <div class="row mt-1 box-info-order-draft" style="cursor: pointer"
                                             onclick="location.href=`{{ route('admin.orders.create', array('shop_id' => $shop->id)) . '?draft=' . $key }}`;return false;">
                                            <div class="col-6 p-0">
                                                {!! $shop->name !!}<br>
                                                {{ $shop->address }}
                                            </div>
                        ...
                        <div class="row box-child-actions p-2" id="boxActions">
                            <div class="d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    @if ( $currentUser->can('action_orders_delete') )
        ...
        function deleteDraft() {
            if(document.querySelectorAll('.cbxData:checked').length > 0){
                ...
                if (checkboxes.length > 0) {
                    ...
                    location.href = `{{ route('admin.orders.drafts', array('shop_id' => $shop->id)) }}` + '?rm=' + strDraftKey.slice(0, -1);
                }
            }
        }
            ...
            if(document.querySelectorAll('.cbxData:checked').length > 0){
                ...
                if (checkboxes.length > 0) {
                    ...
                    $.ajax({
                        ...
                        url: `{{ route('api.orders.create-by-draft') }}`,
                        dataType: 'json',
                        type: 'post',
