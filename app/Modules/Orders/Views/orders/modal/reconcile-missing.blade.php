<form action="" method="post" id="frm_reconcile_missing">
    ...
    {{--</div>--}}
    <div class="form-group row mb-1">
        <label class="col-md-3 col-form-label required" for="reconcile_missing_note">Mô tả</label>
        <div class="col-md-9">
            <textarea class="form-control" id="reconcile_missing_note" name="reconcile_missing_note" rows="3" placeholder="Mô tả chi tiết" required></textarea>
        </div>
    </div>
