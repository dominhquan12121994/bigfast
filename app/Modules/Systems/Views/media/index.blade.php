            ...
            <div class="card-body">
                    ...
                    <div class="col-12">
                        <div style="float:left;">
                            @if($parentFolder !== 'disable')
                                <a class="btn btn-primary mt-2" href="{{ route('admin.media.folder.index', [ 'id' => $parentFolder ]) }}">
                                    <i class="cil-level-up"></i>
                                    back
                                </a>
                            @endif
                            <a class="btn btn-primary mt-2" href="{{ route('admin.media.folder.add', [ 'thisFolder' => $thisFolder ]) }}">
                                <i class="cil-plus"></i> 
                        ...
                        <div style="float:left;">
                            <form method="POST" action="{{ route('admin.media.file.add') }}" enctype="multipart/form-data" id="file-file-form">
                ...
                <div class="row">
                        ...
                        <table class="table table-striped table-bordered datatable">
                            <tbody>
                                @foreach($mediaFolders as $mediaFolder)
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin.media.folder.index', [ 'id' => $mediaFolder->id ]) }}">
                                                <i class="cil-folder"></i> 
                                                {{ $mediaFolder->name }}
                                            </a>
                                        </td>
                                ...
                                @foreach($medias as $media)
                                    <tr>
                                        ...
                                        <td>
                                            <a 
                                                href="{{ route('admin.media.file.copy', ['id' => $media->id, 'thisFolder' => $thisFolder]) }}"
                                                class="btn btn-primary"
                                            >   
                                                Copy
                                            </a>
                                        ...
                                        <td>
                                            ...
                                            <a 
                                                ...
                                                href="{{ route('admin.media.file.delete', ['id' => $media->id, 'thisFolder' => $thisFolder]) }}"
                                            >
                                                Delete
                                            </a>
                                            -->
                    ...
                    <div class="card border-primary" id="file-move-folder">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.media.folder.move') }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        ...
                        <div class="card border-primary" id="file-move-file">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.media.file.move') }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <input type="hidden" name="thisFolder" value="{{ $thisFolder }}">
                        ...
                        <div class="card border-primary" id="file-rename-file-card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.media.file.update') }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <input type="hidden" name="thisFolder" value="{{ $thisFolder }}">
                        ...
                        <div class="card border-primary" id="file-rename-folder-card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.media.folder.update') }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <input type="hidden" name="thisFolder" value="{{ $thisFolder }}">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('admin.media.file.delete') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                        <input type="hidden" name="thisFolder" value="{{ $thisFolder }}">
                    ...
                    <div class="modal fade" id="remove-folder-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('admin.media.folder.delete') }}" method="POST">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                        <input type="hidden" name="thisFolder" value="{{ $thisFolder }}">
...
<script src="{{ asset('js/media.js') . '?v=' . config('app.version') }}"></script>
