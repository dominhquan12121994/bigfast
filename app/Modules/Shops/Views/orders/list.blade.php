                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ( in_array($filter['status_detail'], array(11, 35, 31, 36) ) )
                                @include('Shops::orders.shared.order-item.status-active-11')
                            @elseif ( $filter['status_detail'] === 12)
                                @include('Shops::orders.shared.order-item.status-active-12')
                            @elseif ( $filter['status_detail'] === 22)
                                @include('Shops::orders.shared.order-item.status-active-22')
                            @elseif ( $filter['status_detail'] === 23)
                                @include('Shops::orders.shared.order-item.status-active-23')
                            @elseif ( $filter['status_detail'] === 25)
                                @include('Shops::orders.shared.order-item.status-active-25')
                            @elseif ( $filter['status_detail'] === 32)
                                @include('Shops::orders.shared.order-item.status-active-32')
                            @elseif ( $filter['status_detail'] === 34)
                                @include('Shops::orders.shared.order-item.status-active-34')
                            @elseif ( $filter['status'] === 4)
                                @include('Shops::orders.shared.order-item.status-active-4')
                            @elseif ( $filter['status'] === 5)
                                @include('Shops::orders.shared.order-item.status-active-5')
                            @elseif ( in_array($filter['status'], array(9) ) || in_array($filter['status_detail'], array(81, 82) ) )
                                @include('Shops::orders.shared.order-item.status-active-9')
                            @elseif ( in_array($filter['status_detail'], array(83, 84, 73, 74) ) )
                                @include('Shops::orders.shared.order-item.status-active-83')
                            @elseif ( $filter['status'] === 6)
                                @include('Shops::orders.shared.order-item.status-active-6')
                            @elseif ( in_array($filter['status_detail'], array(71, 72) ) )
                                @include('Shops::orders.shared.order-item.status-active-71')
                            @else
                                @include('Shops::orders.shared.order-item')
                            @endif 

                            @if (!isset($search['searchs']))
                            <div class="row">
                                <div class="col-auto mb-3">
                                    @include('Shops::orders.shared.order-actions')
                                </div>
                            ...
                            @include('Shops::orders.shared.right')
...
@include('Shops::contacts.shared.modal-create')
    ...
    <script type="application/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#btnExportExcel').click(function () {
                ...
                let route = '{{ route('shop.orders.export') }}';
        ...
        function shopSelectedChange() {
            ...
            let route = '{{ route('shop.orders.index') }}';
            {{--let route = '{{ route('shop.orders.index', ":slug") }}';--}}
