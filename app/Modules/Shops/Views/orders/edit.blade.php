    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <form method="POST" id="frmOrderStore" action="{{ route('shop.orders.update', array('order' => $order->id)) }}">
                            <div class="card-header justify-content-between d-flex">
                                <div>
                                    <i class="fa fa-align-justify"></i> <strong>{{ __('Chỉnh sửa đơn hàng') }}</strong>
                                </div>
                                <div>
