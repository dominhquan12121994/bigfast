...
class ShopStaffContactsController extends AbstractWebController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Shops::contacts-staff.list', 
            [
                'contacts'      => $contacts, 
    ...
    public function edit($id)
    {
        ...
        return view('Shops::contacts-staff.edit', 
            [
                'listContact'   => $listContact, 
                'users'         => User::all(),
                'level'         => ContactsConstant::level, 
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('shop.contacts-staff.index');
    }
